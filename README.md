...
- ```ci_parameters.txt```: A text file containing the calculated topological quantities ($\delta_{gh}$, $$\Delta_{gh}$$ , $\sigma$, $\theta_s$). This provides a quick human-readable summary of the CI's characters.
